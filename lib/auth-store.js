...
function generateTempPassword() {
  const words = ["corona", "verao", "praia", "duna", "vela", "areia", "sol", "mare", "brisa", "ilha"];
...
module.exports = { getAuthStore, getUserAuth, setUserPassword, touchLastLogin, verifyPassword, generateTempPassword };
